...
list(
    ...
    tar_target(name = artist_names,
               command = make_artist_names()),
    ...
    tar_target(name = artist_language,
               command = make_artist_language()),
    
    tar_target(name = artist_country,
               command = make_artist_country()),
    
    tar_target(name = artist_gender,
               command = make_artist_releases())
