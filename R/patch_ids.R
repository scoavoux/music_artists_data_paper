...
# extra function to get some mbz ids from wikidata
# take missing mbz_artist_ids in all and add them
# if a unique match is provided
...
# after all patching steps, take all remaining duplicates and
# resolve them using known popularity heuristics
# if not possible, drop cases entirely and export them as csv
